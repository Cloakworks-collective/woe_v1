...
export const SCALARS: ScalarMeta[] = [
  ...
  { key: "BOMBARD_VOLLEYS", label: "Volleys per bombardment", unit: "volleys", group: "Combat", value: C.BOMBARD_VOLLEYS, min: 1, step: 1, desc: "How many shots one bombardment throws before the engines stand down. Field battles have no equivalent — a raid, a castle attack and a revenge are each a single exchange." },
