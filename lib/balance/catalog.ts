...
export const SCALARS: ScalarMeta[] = [
  ...
  { key: "ENGINEER_CAP", label: "Engine crews cap", unit: "% of regulars", group: "Covert", value: C.ENGINEER_CAP, min: 0, max: 1, step: 0.01, pct: true, desc: "Crews on the same rule as the shadow arms and twice the room, because a siege park is the larger undertaking. This is what really bounds a siege train: engines you cannot man are engines you may not keep." },
  ...
  { key: "COVERT_CAP_PER_ARM", label: "Spies (or scouts) cap", unit: "% of regulars", group: "Covert", value: C.COVERT_CAPS.PER_ARM, min: 0, max: 1, step: 0.01, pct: true, desc: "Ceiling on each arm as a share of your REGULAR TROOPS — footmen, archers and cavalry. A shadow service is raised behind an army, not beside a population: a ruler who farms and never musters keeps no knives. If someone does field six hundred rangers, they earned them behind twelve thousand soldiers." },
  { key: "COVERT_CAP_COMBINED", label: "Both arms together cap", unit: "% of regulars", group: "Covert", value: C.COVERT_CAPS.COMBINED, min: 0, max: 1, step: 0.01, pct: true, desc: "You cannot be a realm of nothing but knives and rangers — somebody has to farm." },
