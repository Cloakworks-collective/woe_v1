...
export const SCALARS: ScalarMeta[] = [
  ...
  { key: "SORTIE_ENTRENCHED_BONUS", label: "Entrenched (unused)", unit: "%", group: "Siege", value: C.SORTIE.ENTRENCHED_BONUS, min: 0, max: 2, step: 0.05, pct: true, desc: "Not currently read by anything. The besieger's arms fight at flat power in all three clashes of a sortie — the garrison's cavalry bonus is the only multiplier left in the phase. The bonusPool branch that would consume this is still wired, but nothing sets the flag." },
