...
export const SCALARS: ScalarMeta[] = [
  ...
  { key: "MEDICINE_RECOVER_PER_LEVEL", label: "Medicine — recovered per level", unit: "% of fallen sellswords", group: "Mercenaries", value: C.MEDICINE.RECOVER_PER_LEVEL, min: 0, max: 1, step: 0.01, pct: true, desc: "Share of the sellswords who die DEFENDING you that the field hospital pulls off the field alive, per research level. Defence only, and sellswords only — regular dead are the one permanent loss in the game and a hospital that undid that would take the teeth out of every attack." },
