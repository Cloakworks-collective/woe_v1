...
export const BUILDING_INFO: Record<BuildingId, { title: string; tip: string }> = {
  ...
  market_square: { title: "Market Square", tip: "Your gateway to the Grand Bazaar. Merchants are unlimited — each Market Square level lets every caravan haul another 1,000 goods to sell for gold." },
