...
// Works and the vault share a page because they are one decision: the works are
// "paid from the pool", and build/repair spend bypasses the 3× withdrawal cap.
// You cannot sensibly decide to raise the Hall without seeing what's in the pool.
      ...
      >
        {clan.buildings.storageLevel === 0 && (
          <p className="panel-lede" style={{ color: "var(--warn)" }}>
            No Clan Storage built yet — raise it in Clan Works above before the pool can hold anything.
          </p>
        )}
        <table className="tbl">
          <thead>
            ...
            {POOL.map((r) => {
              ...
              return (
                <tr key={r}>
                  ...
                  <td>
                    <CmdForm name="clanDeposit" path="/clan/works">
                  ...
                  <td>
                    <CmdForm name="clanWithdraw" path="/clan/works">
                      <input type="hidden" name="what" value={r} />
